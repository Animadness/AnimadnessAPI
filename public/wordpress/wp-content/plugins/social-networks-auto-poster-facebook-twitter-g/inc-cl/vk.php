...
if (!class_exists("nxs_snapClassVK")) { class nxs_snapClassVK extends nxs_snapClassNT { 
  var $ntInfo = array('code'=>'VK', 'lcode'=>'vk', 'name'=>'VK.Com', 'defNName'=>'uName', 'tstReq' => false, 'instrURL'=>'http://www.nextscripts.com/setup-installation-stumbleupon-social-networks-auto-poster-wordpress/');    
