...
if (!class_exists("nxs_snapClassTW")) { class nxs_snapClassTW extends nxs_snapClassNT { 
  ...
  function adjPreFormatWP(&$options, &$message, $postID){if (!empty($postID)) { 
    
    $twLim = 140;  global $plgn_NS_SNAutoPoster, $nxs_urlLen; $nxs_urlLen = 0; $imgData = '';
    ...
    $message = array('message'=>$msg, 'img'=>$imgData, 'urlLength'=>$nxs_urlLen);  $options['msgFormat'] = $msg;  
  }
