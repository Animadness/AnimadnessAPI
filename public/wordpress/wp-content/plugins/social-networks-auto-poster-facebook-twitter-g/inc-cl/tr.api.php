...
if (!class_exists("nxs_class_SNAP_TR")) { class nxs_class_SNAP_TR {
    ...
    $postinfo = $tum_oauth->post("http://api.tumblr.com/v2/blog/".$options['pgID']."/post", $postArr); // prr("http://api.tumblr.com/v2/blog/".$options['trURL']."/post");  prr($postinfo);  prr($postArr);    
